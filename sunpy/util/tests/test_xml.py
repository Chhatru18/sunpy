...
def test_xml_to_dict2():
    """
    should return dict of xml string and if a tag is duplicated it takes the last one.
    """
    source_xml = "<outer>\
...
def test_xml_to_dict3():
    """
    should return dict of xml string with empty value if there are no inner elements.
    """
    source_xml = "<outer/>"
...
def test_xml_to_dict6():
    """
    should return dict of xml string with 2 layer nesting and if a tag is duplicated it takes the
    last one.
    """
    source_xml = "<outer>\
                    <mid>\
...
def test_with_multiple_children_in_list():
    """
    Setting the 'multiple' attribute of parent node should put child nodes in a list.
    """
