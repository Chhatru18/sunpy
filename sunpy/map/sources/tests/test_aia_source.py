...
def createAIAMap(request):
    """
    Creates an AIAMap as given in documentation examples, through AIA_171_IMAGE or through the use
    of the JP2 file.
    """
...
def test_AIAMap(createAIAMap):
    """
    Tests the creation of AIAMap from AIA_171_IMAGE or through use of the JP2 file.
    """
