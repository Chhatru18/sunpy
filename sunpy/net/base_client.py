"""
This module provides the BaseClient that all download clients are based upon.
"""
...
class BaseClient(ABC):
    ...
    def __init_subclass__(cls, *args, **kwargs):
        ...
        each subclass in a dict that has the `_can_handle_query` attribute. This is then passed into
        the UnifiedDownloaderFactory so we can register them. This means that Fido can use the
        clients internally.
        """
