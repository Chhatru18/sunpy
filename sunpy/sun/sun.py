...
The following code is heavily based on IDL function get_sun.pro which itself is based on algorithms
presented in the book Astronomical Formulae for Calculators, by Jean Meeus. Every function returning
a quantity is of type `astropy.units.Quantity`.
"""
import numpy as np
...
from sunpy.time import julian_centuries, parse_time, _variables_for_parse_time_docstring
