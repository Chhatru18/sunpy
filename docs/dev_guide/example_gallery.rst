...
.. note:: We have an example template located at ``examples/example-template/example-template.py``.
...
* Wherever possible, the examples should include linked references with links pointing to the appropriate DOI or `ADS <https://ui.adsabs.harvard.edu/>`_ entry.
